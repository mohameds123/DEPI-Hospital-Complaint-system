...
class NewPatientComplain extends StatefulWidget {
  const NewPatientComplain({super.key});

  @override
  State<NewPatientComplain> createState() => _NewPatientComplainState();
}

class _NewPatientComplainState extends State<NewPatientComplain> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Submit Request
            SubmitButton(reporttype: '$selectedSubmission'),
          ],
        ),
      ),
    );
